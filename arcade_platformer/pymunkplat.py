...
class GameWindow(arcade.Window):
    ...
    def setup(self):
        ...
        self.physics_engine = arcade.PymunkPhysicsEngine(damping=0.99, gravity=(0, -900))
        self.physics_engine.add_sprite(self.player_sprite, friction=0.6, mass=2.0, moment=arcade.PymunkPhysicsEngine.MOMENT_INF, collision_type="player")
        ...
        self.physics_engine.add_sprite_list(self.moving_sprites_list, friction=0.6, collision_type="moving")
