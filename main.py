...
character = Player()  # Position is set within the class to be at the center
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            ...
            if event.key == K_SPACE:
                character.attack()
            # Was it the E key? If so, pick up.
    ...
    character_pos = character.rect.center
    world_offset[0] = WIDTH // 2 - character_pos[0]
    world_offset[1] = HEIGHT // 2 - character_pos[1]
