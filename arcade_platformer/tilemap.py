...
class PlatformerView(arcade.View):
    ...
    def setup(self) -> None:
        ...
        # Load the current map using TileMap
        tile_map = TileMap(map_path, scaling=game.MAP_SCALING)

        # Load the layers
        self.background = tile_map.sprite_lists[background_layer]
        self.goals = tile_map.sprite_lists[goal_layer]
        self.walls = tile_map.sprite_lists[wall_layer]
        self.ladders = tile_map.sprite_lists[ladders_layer]
        self.coins = tile_map.sprite_lists[coin_layer]
